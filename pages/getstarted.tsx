...
const GetStarted = () => {
  ...
  useEffect(() => {
    ...
    if (JSON.parse(localStorage.getItem("userInfo")!)){
      ...
      console.log(JSON.parse(localStorage.getItem("userInfo")!));
      formData.email = JSON.parse(localStorage.getItem("userInfo")!).email;
    } else {
      router.push("/")
    }
  }, []);
                  ...
                  <div className="date-picker">
                    <div className="flex flex-col lg:items-start lg:justify-start mb-10">
                      ...
                      <div className="text-gray-500 lg:text-start text-center">
                        We pick up Monday-Saturday. We'll text you the morning
                        of your pickup with an <br /> estimated arrival time.
                      </div>
                    </div>
            ...
            {multiStepForm == 2 ? (
              <div className="flex justify-around">
                ...
                <div className="hidden md:block bg-blue-100 w-[20%] h-fit border-blue-500 border text-gray-900 rounded-xl p-5">
                  ...
                  <div className="mt-4">
                    You only need to enter your pickup details once. We'll save
                    it for next time
                  </div>
                </div>
              </div>
                ...
                <div className="hidden lg:block bg-blue-100 w-[20%] h-fit border-blue-500 border text-gray-900 rounded-xl p-5">
                  <div className="flex space-x-5">
                    <img
                      ...
                      src={
                        "https://www.returnmates.com/assets/images/monica.png"
                      }
                    />
                    <div>
